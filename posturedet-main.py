...
# Load BLIP for image captioning (using the base model for improved availability)
...
while True:
    ...
    # Run object detection with verbose=False to clean up console output
    ...
    # Generate a caption for the scene with a custom prompt to improve human activity descriptions
